# Generated by Powerlevel10k configuration wizard on 2022-10-07 at 23:22 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    private_mode            # custom private mode
  ...
  ## private mode
  function prompt_private_mode() {
    if [[ -n "$ZSH_PRIVATE_MODE" ]]; then
      p10k segment -b 52 -i "🔒"
    fi
  }
